...
We noticed after running the function a few times that a lot of commitees are not affiliated with a party.  This results in all of the bars being coded the same color, for NA.  
